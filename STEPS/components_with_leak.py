...
######################################################
###ER_Leak
def get_leak(ssys, mdl, Ca):    
    leakMol = {}
    for mol in leakMolName:
        leakMol.update({mol: smodel.Spec(mol, mdl)})
    R_leak={}    
    R_leak['ER_to_cyt'] = smodel.SReac('R_ER_to_cyt', ssys, slhs=[leakMol['leak']], ilhs=[Ca], srhs=[leakMol['leak']], orhs=[Ca], kcst=k_leak)
    R_leak['cyt_to_ER'] = smodel.SReac('R_cyt_to_ER', ssys, slhs=[leakMol['leak']], olhs=[Ca], srhs=[leakMol['leak']], irhs=[Ca], kcst=k_leak)
    
    return leakMol,R_leak
...
def get_cb(vsys, mdl, Ca):
    ...
    R_cb = {}
    R_cb['cb0010'] = smodel.Reac('R_cb0010', vsys, lhs=[cbMol['H0M0'], Ca], rhs=[cbMol['H1M0']], kcst=2*cbHon)
    R_cb['cb1000'] = smodel.Reac('R_cb1000', vsys, lhs=[cbMol['H1M0']], rhs=[cbMol['H0M0'], Ca], kcst=cbHoff)
    R_cb['cb1020'] = smodel.Reac('R_cb1020', vsys, lhs=[cbMol['H1M0'], Ca], rhs=[cbMol['H2M0']], kcst=cbHon)
    R_cb['cb2010'] = smodel.Reac('R_cb2010', vsys, lhs=[cbMol['H2M0']], rhs=[cbMol['H1M0'], Ca], kcst=2*cbHoff)
    R_cb['cb0111'] = smodel.Reac('R_cb0111', vsys, lhs=[cbMol['H0M1'], Ca], rhs=[cbMol['H1M1']], kcst=2*cbHon)
    R_cb['cb1101'] = smodel.Reac('R_cb1101', vsys, lhs=[cbMol['H1M1']], rhs=[cbMol['H0M1'], Ca], kcst=cbHoff)
    R_cb['cb1121'] = smodel.Reac('R_cb1121', vsys, lhs=[cbMol['H1M1'], Ca], rhs=[cbMol['H2M1']], kcst=cbHon)
    R_cb['cb2111'] = smodel.Reac('R_cb2111', vsys, lhs=[cbMol['H2M1']], rhs=[cbMol['H1M1'], Ca], kcst=2*cbHoff)
    R_cb['cb0212'] = smodel.Reac('R_cb0212', vsys, lhs=[cbMol['H0M2'], Ca], rhs=[cbMol['H1M2']], kcst=2*cbHon)
    R_cb['cb1202'] = smodel.Reac('R_cb1202', vsys, lhs=[cbMol['H1M2']], rhs=[cbMol['H0M2'], Ca], kcst=cbHoff)
    R_cb['cb1222'] = smodel.Reac('R_cb1222', vsys, lhs=[cbMol['H1M2'], Ca], rhs=[cbMol['H2M2']], kcst=cbHon)
    R_cb['cb2212'] = smodel.Reac('R_cb2212', vsys, lhs=[cbMol['H2M2']], rhs=[cbMol['H1M2'], Ca], kcst=2*cbHoff)
    R_cb['cb0001'] = smodel.Reac('R_cb0001', vsys, lhs=[cbMol['H0M0'], Ca], rhs=[cbMol['H0M1']], kcst=2*cbMon)
    R_cb['cb0100'] = smodel.Reac('R_cb0100', vsys, lhs=[cbMol['H0M1']], rhs=[cbMol['H0M0'], Ca], kcst=cbMoff)
    R_cb['cb0102'] = smodel.Reac('R_cb0102', vsys, lhs=[cbMol['H0M1'], Ca], rhs=[cbMol['H0M2']], kcst=cbMon)
    R_cb['cb0201'] = smodel.Reac('R_cb0201', vsys, lhs=[cbMol['H0M2']], rhs=[cbMol['H0M1'], Ca], kcst=2*cbMoff)
    R_cb['cb1011'] = smodel.Reac('R_cb1011', vsys, lhs=[cbMol['H1M0'], Ca], rhs=[cbMol['H1M1']], kcst=2*cbMon)
    R_cb['cb1110'] = smodel.Reac('R_cb1110', vsys, lhs=[cbMol['H1M1']], rhs=[cbMol['H1M0'], Ca], kcst=cbMoff)
    R_cb['cb1112'] = smodel.Reac('R_cb1112', vsys, lhs=[cbMol['H1M1'], Ca], rhs=[cbMol['H1M2']], kcst=cbMon)
    R_cb['cb1211'] = smodel.Reac('R_cb1211', vsys, lhs=[cbMol['H1M2']], rhs=[cbMol['H1M1'], Ca], kcst=2*cbMoff)
    R_cb['cb2021'] = smodel.Reac('R_cb2021', vsys, lhs=[cbMol['H2M0'], Ca], rhs=[cbMol['H2M1']], kcst=2*cbMon)
    R_cb['cb2120'] = smodel.Reac('R_cb2120', vsys, lhs=[cbMol['H2M1']], rhs=[cbMol['H2M0'], Ca], kcst=cbMoff)
    R_cb['cb2122'] = smodel.Reac('R_cb2122', vsys, lhs=[cbMol['H2M1'], Ca], rhs=[cbMol['H2M2']], kcst=cbMon)
    R_cb['cb2221'] = smodel.Reac('R_cb2221', vsys, lhs=[cbMol['H2M2']], rhs=[cbMol['H2M1'], Ca], kcst=2*cbMoff)
