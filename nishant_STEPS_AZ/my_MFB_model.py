...
def simAZtest(T, CaData, sim, r, RRP=29, refracTau=6.33e-3):
    CaData = CaData*1e-6
    sim.reset()
    r.initialize(randint(1, 1000000))
    ...
    return resCa, resAZ, vesRel


def simAZ(T, CaData, sim, r, RRP=7, refracTau=6.33e-3):
    CaData = CaData*1e-6
    sim.reset()
